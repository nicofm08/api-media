...
from app.core.constants import LOG_CORE, MONGO_URI
from app.solution.models.response_model import ErrorResponse, APIResponse
    ...
    async def insert_one(self, document):
        ...
        try:
            ...
            if "duplicate key error" in str(e):
                ...
                raise CustomAPIResponse(status_code=209, message="Duplicate key error")
            else:
